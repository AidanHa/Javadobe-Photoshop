...
typedef struct {
    ...
    uint16_t pressure3;                 //between 0 and 999
    uint16_t rocket_mass;               //between 0 and 999 (measured in decipounds. Don't judge me)
    uint16_t ign_pri_current;           //between 0 and 999 (measured in centiamps. these dumb units are for easy human readable output)I1
    uint16_t ign_sec_current;           //between 0 and 999 (measured in centiamps)I2
